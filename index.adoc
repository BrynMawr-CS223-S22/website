...
[.anns]
* Current Agenda: link:#week12[Week12]
* link:assts/asst09.html[Assignment A09 Due]: *April 8* and *April 15* (Two Parts)
* **Jam 05: April 21**  link:studyguide5.html[Study Guide 05]

== Course Info

**Welcome to CS223: Systems Programming**! 
The primary goal of this course is to develop skills for writing programs that are  "hardware-aware" and capable of interacting directly with the operating system. 
