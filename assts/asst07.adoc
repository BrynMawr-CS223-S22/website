...
**Friday, March 25, before midnight**
...
5) Place a breakpoint in `computeValue`. How many times is `computeValue` called by the program?
{nbsp} +
{nbsp} +
{nbsp} +
{nbsp} +
...
6) What is `computeValue` doing? From the given source, we can see it takes a string. What is the return value?  
{nbsp} +
{nbsp} +
{nbsp} +
{nbsp} +
