...
* You should re-use your PPM and mandelbrot functions from A09. If you use a 2D array of arrays, be sure to modify and commit `read_ppm.h`!
* Each step of the algorithm should be multithreaded
* To debug, try visualizing the output at sub-steps. For example, you can convert the membership array to colors to visualize it.
